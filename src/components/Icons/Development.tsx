...
export interface IDevelopmentIcon {
  title?: string;
  titleId?: string;
}

const DevelopmentIcon: React.FC<IDevelopmentIcon> = ({
  title,
  titleId,
  ...props
}): JSX.Element => (
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <g fillRule="nonzero">
        <g transform="translate(85 131)">
          ...
          <ellipse fill="#701AAC" cx={48.08} cy={124.17} rx={22.69} ry={38.1} />
          <ellipse
            fill="url(#prefix__y)"
            cx={51.51}
            cy={211.79}
            ...
            ry={38.1}
          />
          <path fill="#00DDD2" d="M268.4 161.7l-.77 36.1 15.29-.8.78-36.07z" />
          <path
            fill="#00CCBD"
      ...
      <g fillRule="nonzero">
        ...
        <g fill="url(#prefix__G)" opacity={0.73} transform="translate(620 75)">
...
export default React.memo(DevelopmentIcon);
